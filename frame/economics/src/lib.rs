...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn burn(
            ...
            ensure!(T::Currency::free_balance(&who) - T::Currency::minimum_balance() >= amount, Error::<T>::KillAcount);
            // Locked balances are not allowed to burn
            T::Currency::ensure_can_withdraw(&who, amount, WithdrawReasons::TRANSFER, T::Currency::free_balance(&who) - amount)
